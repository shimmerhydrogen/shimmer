...
if run_tests(8) > 0
    disp("Run test_inrete_full");
    graph_path = fullfile(pwd, "graphs/test_inrete_full/InreteNet.mat");
    graph = load(graph_path);
    graph = graph.gasNet_Res;
    db_path = fullfile(pwd, "graphs/test_inrete_full/test_inrete.db");
