...
int initialize_test_db(void)
{
    ...
    std::vector<setting_pipe> settings_pipe = {
        { "pipe_0_3",   0,  3,   80000,	1.2,	1.20E-05 },
        { "pipe_1_2",   1,  2,   16000,	0.6,	1.20E-05 },
        { "pipe_2_3",   2,  3,   40000,	0.8,	1.20E-05 },
        { "pipe_2_4",   2,  4,  160000,	0.7,	1.20E-05 },
        { "pipe_3_4",   3,  4,  200000,	0.8,	1.20E-05 },
        { "pipe_4_5",   4,  5,   24000,	0.6,	1.20E-05 },
        { "pipe_4_7",   4,  7,  120000,	0.2,	1.20E-05 },
        { "pipe_6_4",   6,  4,   80000,	0.9,	1.20E-05 },
        { "pipe_7_6",   7,  6,   64000,	0.7,	1.20E-05 },
        { "pipe_11_6", 11,  6,  240000,	0.6,	1.20E-05 },
        { "pipe_12_7", 12,  7,   28000,	0.2,	1.20E-05 },
        { "pipe_8_7",   8,  7,   80000,	0.9,	1.20E-05 },
        { "pipe_7_9",   7,  9,  160000,	0.7,	1.20E-05 },
        { "pipe_9_10",  9, 10,   40000,	0.3,	1.20E-05 },
        { "pipe_3_9",   3,  9,  320000,	0.9,	1.20E-05 }
    };
